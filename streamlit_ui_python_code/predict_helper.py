...
model_rest = load("artifacts/premium_model_rest.joblib")
model_young = load("artifacts/premium_model_young.joblib")

scaler_rest = load("artifacts/premium_scaler_rest.joblib")
scaler_young = load("artifacts/premium_scaler_young.joblib")
...
def preprocess_input(input_dict):
    ...
    df = pd.DataFrame(0, columns=desired_columns, index=[0])
    ...
    df = handle_scale(input_dict['Age'], df)

    return df

def handle_scale(age, df):
